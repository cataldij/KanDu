  ...
  const generateArticleContent = (
    ...
    const articles: Record<string, ArticleContent> = {
      'Replace HVAC Filter': {
        ...
        products: [
          {
            name: 'Filtrete MPR 1500 Air Filter 4-Pack',
            description: 'Top-rated filter captures 93% of airborne particles. Lasts 3 months.',
            price: '$39.99',
            affiliateLink: 'https://amazon.com/dp/B00FH4XE8W?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/81Z8Y0ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'Nordic Pure MERV 12 Pleated Filter',
            description: 'Budget-friendly option with excellent filtration. Made in USA.',
            price: '$24.99',
            affiliateLink: 'https://amazon.com/dp/B00FQHF8E0?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71yN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Fix Leaky Faucet': {
        ...
        products: [
          {
            name: 'Danco Assorted Faucet Washer Kit',
            description: '26-piece kit with all common sizes. Perfect for any faucet repair.',
            price: '$8.99',
            affiliateLink: 'https://amazon.com/dp/B00DZXARVQ?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/81kQZ5ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'TEKTON Adjustable Wrench Set',
            description: '2-piece set (6" and 10"). Essential for any home toolkit.',
            price: '$16.99',
            affiliateLink: 'https://amazon.com/dp/B00JL5YQWM?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71yN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Install Smart Outlet': {
        ...
        products: [
          {
            name: 'Kasa Smart Wi-Fi Outlet (2-Pack)',
            description: 'Works with Alexa & Google Home. No hub required. Track energy usage.',
            price: '$24.99',
            affiliateLink: 'https://amazon.com/dp/B07RCNB2L3?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/61D8JL-XPNL._AC_SL1500_.jpg',
          },
          {
            name: 'Klein Tools Voltage Tester',
            description: 'Non-contact tester for safety. Beeps when voltage detected.',
            price: '$19.99',
            affiliateLink: 'https://amazon.com/dp/B004FXJOQO?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71bN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Unclog Drain': {
        ...
        products: [
          {
            name: 'FlexiSnake Drain Weasel Sink Snake',
            description: 'Rotating handle clears hair clogs instantly. Reusable and easy to clean.',
            price: '$9.99',
            affiliateLink: 'https://amazon.com/dp/B01DP87IF8?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71zN8ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'Vastar Drain Snake 3-Pack (19.6")',
            description: 'Disposable plastic drain cleaners. Perfect for bathroom sinks.',
            price: '$6.99',
            affiliateLink: 'https://amazon.com/dp/B01DP87G6O?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/81nN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Caulk Bathtub': {
        ...
        products: [
          {
            name: 'GE Supreme Silicone Kitchen & Bath Caulk',
            description: 'Mold & mildew resistant. 100% waterproof. Crystal clear finish.',
            price: '$6.99',
            affiliateLink: 'https://amazon.com/dp/B0002YW3VI?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71mN8ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'Newborn 250 Smooth Rod Caulk Gun',
            description: 'Professional-grade gun with smooth trigger. Makes caulking easy.',
            price: '$12.99',
            affiliateLink: 'https://amazon.com/dp/B000BQRC3M?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/61kN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Replace Doorknob': {
        ...
        category: 'DIY',
        imageUrl: 'https://images.unsplash.com/photo-1581092918484-8313e1f177c6?w=800',
        timeEstimate: '15 minutes',
        difficulty: 'Easy',
        sections: [
          {
        ...
        products: [
          {
            name: 'Kwikset Juno Entry Door Knob',
            description: 'Top-rated entry knob with key. Fits standard doors. Lifetime warranty.',
            price: '$24.99',
            affiliateLink: 'https://amazon.com/dp/B000BQXE9C?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71wN8ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'AmazonBasics Privacy Door Knob',
            description: 'Interior door knob with push-button lock. Perfect for bedrooms/bathrooms.',
            price: '$14.99',
            affiliateLink: 'https://amazon.com/dp/B08KQ39W7P?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/61pN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Patch Drywall': {
        ...
        products: [
          {
            name: '3M High Strength Patch Plus Primer',
            description: 'Self-adhesive patch for holes up to 8". No sanding required.',
            price: '$9.99',
            affiliateLink: 'https://amazon.com/dp/B000BQOX8O?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/81rN8ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'DAP DryDex Spackling (16 oz)',
            description: 'Goes on pink, dries white. Shows when ready to sand. Interior/exterior.',
            price: '$6.99',
            affiliateLink: 'https://amazon.com/dp/B000BQOX6W?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71sN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Install Shelf': {
        ...
        products: [
          {
            name: 'IRONCK Floating Shelves Set of 2',
            description: 'Rustic wood wall shelves. Easy to install. Holds up to 33 lbs each.',
            price: '$29.99',
            affiliateLink: 'https://amazon.com/dp/B07YNWHQ7P?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/81vN8ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'Zircon StudSensor e50 Stud Finder',
            description: 'Finds studs instantly. Deep scanning mode. Edge detection.',
            price: '$19.99',
            affiliateLink: 'https://amazon.com/dp/B001VLBF6M?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71uN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Replace Showerhead': {
        ...
        products: [
          {
            name: 'Moen Magnetix Handheld Showerhead',
            description: '6-spray settings. Magnetic dock. Easy to clean nozzles. Best seller.',
            price: '$39.99',
            affiliateLink: 'https://amazon.com/dp/B07XJZQ14M?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71xN8ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'Teflon Thread Seal Tape 5-Pack',
            description: 'Standard size for plumbing. Professional grade. Won\'t tear.',
            price: '$6.99',
            affiliateLink: 'https://amazon.com/dp/B000BQOXLY?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71yN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
      'Clean Garbage Disposal': {
        ...
        products: [
          {
            name: 'Plink Garbage Disposal Cleaner 20-Pack',
            description: 'Foaming pods break down buildup. Fresh scent. Safe for all disposals.',
            price: '$7.99',
            affiliateLink: 'https://amazon.com/dp/B00COXL91O?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/81zN8ZXPNL._AC_SL1500_.jpg',
          },
          {
            name: 'Glisten Disposal Care Foaming Cleaner',
            description: 'Removes odor-causing residue. Safe for pipes. Lemon scent.',
            price: '$5.99',
            affiliateLink: 'https://amazon.com/dp/B000BQOXP8?tag=kandu-20',
            imageUrl: 'https://m.media-amazon.com/images/I/71aNN8ZXPNL._AC_SL1500_.jpg',
          },
        ],
      },
